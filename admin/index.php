    ...
    ?>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                $unnaproved_comment_count=mysqli_num_rows($select_all_unnaproved_comments);

                $query = "SELECT * FROM users WHERE user_role = 'Subscriber'";
                $select_all_subscribed_users = mysqli_query($connection,$query);
                $subscriber_count=mysqli_num_rows($select_all_subscribed_users);
                ?>
                <div class="row">
                    <script type="text/javascript">
                        ...
                        function drawChart() {
                            var data = google.visualization.arrayToDataTable([
                                ...
                                $element_count = [$post_counts,$post_published_count,$post_draft_count,$comment_counts,$unnaproved_comment_count,$user_counts,$subscriber_count,$category_counts];
                                for($i=0;$i<8;$i++){
